...
export const lab = [
  {
    ...
    system: [
      ...
      { label: "Perspective", value: "Aerial" },
      { label: "Subject", value: "Vehicle" },
      { label: "State", value: "In Motion" },
      {},
      { label: "Environment", value: "Isolated" },
      { label: "Direction", value: "Linear" },
...

  {
    ...
    system: [
      ...
      { label: "Typology", value: "Interior Space" },
      { label: "Climate", value: "Controlled" },
      { label: "Use", value: "Dwelling" },
      {},
      { label: "Light Source", value: "Natural / Filtered" },
      { label: "Envelope", value: "Layered" },
      { label: "Structure", value: "Exposed" },
      { label: "Relation", value: "Interior–Landscape" },
    ],
...

  {
    ...
    system: [
      ...
      { label: "Material Logic", value: "Continuous Surface" },
      { label: "Geometry", value: "Curvilinear" },
      { label: "State", value: "Monolithic" },
      {},
      { label: "Construction", value: "Single Gesture" },
      { label: "Structure", value: "Embedded" },
      { label: "Function", value: "Implicit" },
      { label: "Expression", value: "Form-driven" },
    ],
...

  {
    ...
    system: [
      ...
      { label: "Scale", value: "Spatial Detail" },
      { label: "Geometry", value: "Continuous" },
      { label: "Form", value: "Curvilinear" },
      {},
      { label: "Light", value: "Directional" },
      { label: "Material", value: "Smooth Surface" },
      { label: "Structure", value: "Implicit" },
      { label: "Atmosphere", value: "Silent" },
    ],
